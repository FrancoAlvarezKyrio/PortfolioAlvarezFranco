           ...
           <div className='introLeftWrapper'>
                ...
                <div className='introTitle'>
                    <div className='introTitleWrapper'>
                        <div className='introTitleItem'>Desarrollador web Front end</div>
                        <div className='introTitleItem'>JavaSript</div>
                        <div className='introTitleItem'>ReactJS</div>
                        <div className='introTitleItem'>Bootstrap</div>
                        <div className='introTitleItem'>Sass</div>
                        <div className='introTitleItem'>Git / GitHub</div>
                    </div>
                </div>
